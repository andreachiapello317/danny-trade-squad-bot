...
La ricerca, la classifica e Telegram girano insieme ogni **6 ore**. Aprire o ricaricare la pagina **non** lancia una nuova caccia: restano i dati dell’ultimo ciclo. Arriva **un** messaggio solo se i 4 token sono cambiati. Nel messaggio ogni riga ha il mint da copiare, il link X, il grafico DexScreener, il punteggio pump e perché comprarlo.
